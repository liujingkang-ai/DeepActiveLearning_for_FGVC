...
class ClsNet(nn.Module):
    def __init__(self, inner_dim=128, object_dim=2048, kernel_size=8, feat_dim=512, num_class=200):
        super().__init__()
        ...
        self.cls = nn.Linear(inner_dim*(1+13+21), num_class)

        self.cls = nn.Sequential(
            nn.BatchNorm1d(inner_dim*(1+13+21)),
            nn.Linear(inner_dim*(1+13+21), num_class * 4),
